...
def loadOsdeps(cfg):
    ...
    if platform == "Linux":
        ...
        cfg["osdeps"].update({
            ...
            "graphviz": [install],
#            "nlohmann-json": [install, "nlohmann-json3-dev"],
            "libgit2": [install, "libgit2-dev"],
            "libspdlog": [install, "libspdlog-dev"],
            "libxml2": [install, "libxml2-dev"],
            "pybind11": [install, "pybind11-dev"],
            "pybind11_json": [install, "pybind11-json-dev"],
            "sigc": [install, "libsigc++-2.0-dev"],
            "avahi": [install, "avahi-daemon libavahi-client3 libavahi-client-dev libavahi-core-dev"],
            "automake": [install],
            "libtool": [install],
            "utilrb": [gemInstall],
